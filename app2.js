...
MongoClient.connect(url, opts, function(err, db) {
    ...
    ensureIndex(db, 'configStr', (err, res) => {
        console.log(err);
        console.log(res);
    });
    // return;
    ...
    //     insertDocuments(db, 'configStr', function() {
    //         // console.log("insert succ:"+(++i));
    //     });
    // }, 10);
    // // return;
    // var t = setInterval(function() {
    //     findDocPage(page++, db, 'configStr', function(err, res) {
    //             if (err) {
    //                 return;
    //             }
    ...
    //     findDocPage(page1++, db, 'configStr', function(err, res) {
    //             if (err) {
    //                 return;
    //             }
    ...
    var t = setInterval(function() {
        findDocPage(page, db,'configStr', function(err, res) {
            ...
            res.forEach(function(item) {
                updateDoc(item, db, 'configStr',function(err) {
                    if (err) {
                        return;
                    }
                    if (++j%100 == 0) {
...
function insertDocuments(db, cocname,  cb) {
    ...
    for (var i = 0; i < 10; ++i) {
        ...
        o._id = mongodb.ObjectId().toHexString();
        o.ind = i;
        data.push(o);
    }
    // coc.insertOne()
